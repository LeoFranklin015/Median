    ...
    <div className="w-full py-24 bg-background">
      <div className="max-w-[680px] mx-auto">
        ...
        >
          ...
          >
            <a
              href={buttonHref}
              className="inline-block px-5 py-2.5 rounded-full bg-card text-foreground text-[15px] font-medium leading-6 text-center whitespace-nowrap transition-all duration-75 ease-out w-[182px] cursor-pointer hover:shadow-lg"
              style={{
                boxShadow:
                  "0 -1px 0 0 rgb(100, 100, 100) inset, -1px 0 0 0 rgb(80, 80, 80) inset, 1px 0 0 0 rgb(80, 80, 80) inset, 0 1px 0 0 rgb(80, 80, 80) inset",
      ...
      <div className="h-[268px] -mt-6 mb-0 pb-0 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0), rgba(20, 20, 20, 1))",
          }}
        />
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(90deg, rgba(20, 20, 20, 1), rgba(0, 0, 0, 0))",
          }}
        />
